...
const assets_attachment_entity_1 = require("./assets-attachment.entity");
var AssetState;
(function (AssetState) {
...
__decorate([
    (0, typeorm_1.OneToMany)(() => assets_attachment_entity_1.AssetAttachmentsEntity, (assetAttachment) => assetAttachment.asset, {
        eager: true,
        cascade: true,
    }),
    __metadata("design:type", Array)
], Assets.prototype, "attachments", void 0);
Assets = __decorate([
    (0, typeorm_1.Entity)()
], Assets);
