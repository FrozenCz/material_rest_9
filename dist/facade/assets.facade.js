...
let AssetsFacade = class AssetsFacade {
    constructor(assetsService, ws, locationService) {
...
AssetsFacade = __decorate([
    ...
    __metadata("design:paramtypes", [assets_service_1.AssetsService, ws_gateway_1.WsGateway, locations_service_1.LocationsService])
], AssetsFacade);
